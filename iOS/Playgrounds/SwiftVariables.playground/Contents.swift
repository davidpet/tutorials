...
let t2: String    //initializing a constant (or variable) can be deferred (eg. to select between values in if/else condition) [condition/init must be exhaustive if used (can exit without using)]
t2 = "hi"
